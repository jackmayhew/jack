import { GITHUB_USERNAME, WEBSITE_URL } from '~/constants/social-links'
...
export function setupHead() {
  ...
  useHead({
    ...
    meta: [
      ...
      { property: 'og:image', content: `${WEBSITE_URL}/img/meta/og.png` },
      { property: 'og:locale', content: 'en_US' },
      // twitter
      { property: 'twitter:card', content: 'summary_large_image' },
      { property: 'twitter:url', content: WEBSITE_URL },
      ...
      { property: 'twitter:image', content: `${WEBSITE_URL}/img/meta/twitter.png` },
