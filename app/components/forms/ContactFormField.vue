...
const inputClasses = computed(() => [
  ...
  'ring-0 p-2 rounded-md text-base border-2 dark:bg-transparent duration-20s0 ease-in-out focus:outline-none focus:ring-2 border-neutral-500 dark:border-neutral-600',
